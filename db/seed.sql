...
VALUES
  ...
  ('Storage Unit F', '5x5', 75, '2023-10-20', 'Storage', 5, 3, FALSE, 3, 'Perfect for guitar or similar size instruments or stuff.', 'https://2.bp.blogspot.com/-Uc9WayxakFg/Trgr8_mgryI/AAAAAAAADV4/58CbVYgRxGw/s1600/blog.jpg'),
  ('Storage Unit G', '10x10', 120, '2023-10-25', 'Storage', 2, 1, TRUE, 5, 'This place is in basement.Long term prefered.Appoinment is needed for access.', 'https://images.hgmsites.net/lrg/empty-garage_100321409_l.jpg'),
  ('Storage Unit H', '10x9', 20, '2023-10-25', 'Storage', 2, 1, FALSE, 5, 'Decent space to hold stuff you dont want to get rid off.This place is gated and under constant camera view.Secure.', 'https://blog.markzproperties.com/hubfs/unfinished-basement.jpg'),
  ('Storage Unit N', '8x6', 70, '2023-10-31', 'Storage', 7, 8, FALSE, 4, 'Longer the lease better the price.Any question contact me.', 'https://images.squarespace-cdn.com/content/v1/529aa1d6e4b0665935f83a70/1527717294092-V2BWQGCI0MH15CCPQO2G/Empty+coat+closets+with+hangers+ready+for+guests'),
  ('Storage Unit I', '20x10', 200, '2023-10-30', 'Storage', 1, 2, FALSE, 4, 'Garage spot for long term parking. Not for daily coming and going. Car will be inside the garage but blocked from exit. Ideal for someone looking to store their car or park long term to fly out of JFK. The entrance and exit will be monitored by video. Please reach out if you have any questions.', 'https://media.istockphoto.com/id/178594527/photo/clean-garage.jpg?s=612x612&w=0&k=20&c=0pMNJ53-lcC2kiMgNJSyqsUZVThnDRksbHd751mzoUk=');
