...
INSERT INTO users (first_name, last_name, address, email, phone, is_verified, password, created_at, role, image)
VALUES
...
VALUES
  ('892 Gerard Ave', 'APT 2F', 'Bronx', 'NY', '10452', '4x4', 50, '2023-10-15', 'closet', 1, 2, TRUE, 4,'It is big enough for suitcase’s and or clothes.', 'https://i1.wp.com/simplyalignedhome.com/wp-content/uploads/2020/02/Small-closet-with-wire-shelving-removed-scaled.jpg?fit=770%2C1024'),
  ('910 Grand Concourse', 'Flr 2', 'Bronx', 'NY', '10451', '5x5', 75, '2023-10-20', 'basement', 2, 3, FALSE, 3, 'Max safe and super secure safe box that can hold documents and valuables', 'https://static.wixstatic.com/media/ca2c56_6bb2e8d868154adc96923e469a9b8017~mv2.jpeg/v1/fill/w_640,h_896,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/ca2c56_6bb2e8d868154adc96923e469a9b8017~mv2.jpeg'),
  ('994 Southern Blvd', 'APT 3C', 'Bronx', 'NY', '10459', '10x10', 120, '2023-10-25', 'backyard', 3, 4, TRUE, 5,'This is a gated parking lot located outside of the building without cover. Please long term parking only.', 'https://2.bp.blogspot.com/-Uc9WayxakFg/Trgr8_mgryI/AAAAAAAADV4/58CbVYgRxGw/s1600/blog.jpg'),
  ('170 E 94th St', 'APT 5D', 'New York', 'NY', '10128', '10x20', 200, '2023-10-30', 'alleyway', 4, 5, FALSE, 4,'Large open lot fits a truck or cars. This is safe and accessible neighborhood. This lot is secure and has an extra gate.', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRB3j6GzsGPqo9rCYCA-PipTv0zLBK_tNr9Ow&usqp=CAU'),
  ('330 E 74th St', 'APT 5L', 'New York', 'NY', '10021', '4x4', 50, '2023-10-15', 'closet', 5, 6, TRUE, 4, 'For long term only, small space, weather proof.', 'https://live.staticflickr.com/8039/8060796754_b479c6c58d_b.jpg'),
  ('413 E 50th St', 'APT 10L', 'New York', 'NY', '10022', '5x5', 75, '2023-10-20', 'closet', 5, 3, FALSE, 3, 'Perfect for guitar or similar size instruments or stuff.', 'https://2.bp.blogspot.com/-Uc9WayxakFg/Trgr8_mgryI/AAAAAAAADV4/58CbVYgRxGw/s1600/blog.jpg'),
  ('426 11th Ave', 'Unit 5', 'New York', 'NY', '10018', '10x10', 120, '2023-10-25', 'parking lot', 2, 1, TRUE, 5, 'This place is in basement.Long term prefered.Appoinment is needed for access.', 'https://images.hgmsites.net/lrg/empty-garage_100321409_l.jpg'),
  ('232 W 14th St', 'Floor 3', 'New York', 'NY', '10011', '10x9', 20, '2023-10-25', 'garage', 2, 1, FALSE, 5, 'Decent space to hold stuff you dont want to get rid off.This place is gated and under constant camera view.Secure.', 'https://blog.markzproperties.com/hubfs/unfinished-basement.jpg'),
  ('104-36 37th Dr', 'Apt 9', 'Queens', 'NY', '11368', '8x6', 70, '2023-10-31', 'alleyway', 7, 8, FALSE, 4, 'Longer the lease better the price.Any question contact me.', 'https://images.squarespace-cdn.com/content/v1/529aa1d6e4b0665935f83a70/1527717294092-V2BWQGCI0MH15CCPQO2G/Empty+coat+closets+with+hangers+ready+for+guests'),
  ('2520 E 17th St', 'Apt 9', 'Brooklyn', 'NY', '11235', '20x10', 200, '2023-10-30', 'basement', 1, 2, FALSE, 4, 'Garage spot for long term parking. Not for daily coming and going. Car will be inside the garage but blocked from exit. Ideal for someone looking to store their car or park long term to fly out of JFK. The entrance and exit will be monitored by video. Please reach out if you have any questions.', 'https://media.istockphoto.com/id/178594527/photo/clean-garage.jpg?s=612x612&w=0&k=20&c=0pMNJ53-lcC2kiMgNJSyqsUZVThnDRksbHd751mzoUk=');
